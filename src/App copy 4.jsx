    ...
    <>
      <div className='font-raleway'>
        ...
        <div className='h-screen'>
          <div className="h-1/2 lg:h-screen bg-gradient-to-t from-orange-200 to-red-500 relative overflow-hidden">
            {/* navbar */}
            <nav className='w-full fixed top-0 bg-white z-10'>
              <div className='container mx-auto py-5 flex items-center justify-between'>
                ...
                <ul
                  id='menu'
                  className={`bg-orange-600 absolute left-0 top-0 w-full p-10 rounded-b-3xl space-y-10 text-white text-center transition-all duration-300 ease-in-out ${isMenuOpen ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}
            ...
            {/* texts */}
            <div className='hidden lg:flex flex-col gap-2 absolute top-15 shadow-xl bottom-0 m-auto left-9 bg-white p-6 h-fit w-1/3 rounded-sm'>
          ...
          <div id='about' className='px-10'>
            <div className="container mx-auto py-40 flex-col-reverse lg:flex-row items-center flex gap-20">
              ...
              <div className='my-auto flex flex-col gap-3'>
                ...
                <p className='text-gray-600'>Experiencia en la producción de UX (user experience) y UI (user interface) en el diseño de páginas web e interacciones multimedia. Por último, tengo conocimientos en el uso de React en el Frontend, Node.js para backend y manejo de datos con PostgreSQL y MongoDB.</p>
          ...
          <div id='services'>
            <div className='container mx-auto '>
              ...
              <p className='w-1/2 text-center text-gray-800'>Ofrecer servicios de diseño web en UX/UI (Experiencia de Usuario / Interfaz de Usuario) implica crear sitios web y aplicaciones web que sean fáciles de usar.</p>
              </div>
              {/* bottom */}
              <div className='p-5 sm:p-0 flex flex-wrap justify-between'>
                ...
                <div className='w-full md:w-4/12 shadow-xl rounded-md p-5 my-3 md:my-10 flex flex-col gap-3'>
                  ...
                  <p className='text-gray-700'>Especialista en la creación de sitios web.</p>
            ...
            <div className='container mx-auto '>
              ...
              <h1 className='text-orange-600 font-semibold'>Portafolio</h1>
              <h1 className='text-3xl'>Works and Projects.</h1>
              <p className='w-1/2 text-center text-gray-800'>Descubre mi portafolio de diseño web y UX/UI, donde la estética se une a la funcionalidad. Cada proyecto refleja mi compromiso por crear experiencias digitales memorables que cautivan y conectan con los usuarios..</p>
              </div>
              {/* bottom */}
    ...
    <div id='contact'>
      <div className='container mx-auto'>
        ...
        <div className='flex flex-col gap-3 items-center'>
          ...
          <p className='w-1/2 text-center text-gray-800'>¿Tienes alguna idea?, vamos a discutirlo y hacer algo juntos.</p>
          </div>
