        ...
        <div className='h-screen'>
          <div className="h-1/2 lg:h-screen bg-gradient-to-t from-orange-200 to-red-500">
            ...
            <nav className='w-full fixed top-0 bg-white'>
              ...
              <div id='hamburger' className='space-y-1 md:hidden cursor-pointer'>
                <div className='w-6 h-0.5 bg-orange-500'></div>
                <div className='w-6 h-0.5 bg-orange-500'></div>
                <div className='w-6 h-0.5 bg-orange-500'></div>
              </div>
                <ul id='menu' className='hidden bg-orange-600 absolute left-0 top-0 w-full p-10 rounded-b-3xl space-y-10 text-white text-center'>
                  <li>
                    <a href='#'>Homepage</a>
                  </li>
                  <li>
